...
export class finbankTables1673391846911 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "accounts" ("id" integer NOT NULL, "money" numeric(30,2) NOT NULL DEFAULT 0, CONSTRAINT "PK_5a7a02c20412299d198e097a8fe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO category (name) VALUES ('Compras'), ('Energia'), ('Água'), ('Internet'), ('Boletos'), ('Lazer'), ('Gasto Mensal'), ('Salário')`)
    }
