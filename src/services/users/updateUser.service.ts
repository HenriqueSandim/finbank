...
const updateUserService = async (
  ...
  payload.password
    ? await updateHashedPass()
    : await userRepo.update(userId, { ...payload });
  ...
  const updatedUserResponse: IUserResponse = await returnUserSchema.validate(
    user,
    {
      stripUnknown: true,
    }
